...
class TrajectronDataToLabel(object):
    ...
    def __extract_data(self):
        ...
        road_polygons, yellow_lines, white_lines = p.road_polygons, p.yellow_lines, p.white_lines
        junctions = extractor.extract_junction_with_portals()
        payload = {'road_polygons': road_polygons, 'yellow_lines': yellow_lines,
                'white_lines': white_lines, 'junctions': junctions}
    ...
    def __init__(self, config):
        ...
        try:
            ...
            _, _, _, _ = payload['road_polygons'], \
                    payload['white_lines'], payload['yellow_lines'], payload['junctions']
    ...
    def hardcode_set_node_frequency_multiplier(self, env):
        ...
        counts = util.AttrDict(at_intersection=0, stopped_car=0,
                complete_intersection=0, major_turn=0, minor_turn=0, all=0, other=0)
