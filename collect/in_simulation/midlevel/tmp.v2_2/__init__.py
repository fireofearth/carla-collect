...
TODO: redundant code delete this
"""
...
class MidlevelAgent(AbstractDataCollector):
    ...
    def compute_boundary_constraints(self, x, y):
        """
        Parameters
        ==========
        x : np.array of docplex.mp.vartype.VarType
        y : np.array of docplex.mp.vartype.VarType

        TODO: test this
        """
        mtx = utils.rotation_2d(self.__road_seg_starting[2])
