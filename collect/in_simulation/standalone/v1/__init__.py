...
This motion planner was used to debug the bicycle kinematics model
(originally the bicycle kinematics model oscillates).
The model is working (however imperfect) and this version is sufficient.
"""
