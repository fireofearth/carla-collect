...
from collect.generate.dataset.trajectron import TrajectronDataToLabel
...
def parse_arguments():
    ...
    argparser.add_argument(
            '--dry-run',
            action='store_true',
            help="Don't modify the frequency modifier")
...
def main():
    ...
    counts = data_to_label.hardcode_set_node_frequency_multiplier(env)
